...
//		List<Category> listCategories = categoryService.listCategoriesUsedInForm();
	...
	public String saveProduct(Product product, RedirectAttributes ra,
			...
			@AuthenticationPrincipal ImmobenCustomerDetails loggedCustomer
			) throws IOException {
...
//		}  
		...
		ra.addFlashAttribute("message", "Le produit '" + product.getShortName() + "' avec le numéro Id: " + product.getId() + "  a été modifié avec succès ! ");
	...
	public String deleteProduct(@PathVariable(name = "id") Integer id, 
		...
		try {
			...
			redirectAttributes.addFlashAttribute("message", 
					"Le produit '" + product.getShortName() + "' a été supprimé avec succès !");
	...
	public String editProduct(@PathVariable("id") Integer id, Model model,
			RedirectAttributes ra, @AuthenticationPrincipal ImmobenUserDetails loggedUser,
			@AuthenticationPrincipal ImmobenCustomerDetails loggedCustomer) {
		try {
			Product product = productService.get(id);
			List<City> listCities = cityService.listAll();
