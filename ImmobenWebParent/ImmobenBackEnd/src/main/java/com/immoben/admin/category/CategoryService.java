...
public class CategoryService {
	public static final int ROOT_CATEGORIES_PER_PAGE = 20;
	...
	public Category getCategory(String alias) throws CategoryNotFoundException {
		...
		if (category == null) {
			throw new CategoryNotFoundException("Aucune catégorie avec l'alias: "  + alias + " n'a été trouvée !");
		}
	...
	public Category get(Integer id) throws CategoryNotFoundException {
		try {
			...
			throw new CategoryNotFoundException("Aucune catégorie avec ID: " + id + " n'est trouvable.");
		}
	}
