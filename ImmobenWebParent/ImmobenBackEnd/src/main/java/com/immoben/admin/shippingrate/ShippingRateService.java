...
//	@Autowired private ProductRepository productRepo;
	 ...
	 * String state) throws ShippingRateNotFoundException { ShippingRate
	 * shippingRate = shipRepo.findByCountryAndState(countryId, state);
	 * 
	 * if (shippingRate == null) { throw new
	 * ShippingRateNotFoundException("Aucun tarif d'expédition trouvé pour cette " +
	 ...
	 * product.getHeight()) / DIM_DIVISOR; float finalWeight = product.getWeight() >
	 * dimWeight ? product.getWeight() : dimWeight;
	 * 
