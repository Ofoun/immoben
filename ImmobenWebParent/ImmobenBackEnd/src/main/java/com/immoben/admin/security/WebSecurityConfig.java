...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
			...
			.antMatchers("/categories/**", "/cities/**").hasAnyAuthority("Admin", "Editor")
			...
			.antMatchers("/products", "/products/new", "/products/detail/**", "/products/page/**")
			...
			.and()
				.rememberMe()
					...
					.tokenValiditySeconds(24 * 14 * 24 * 60 * 60);
