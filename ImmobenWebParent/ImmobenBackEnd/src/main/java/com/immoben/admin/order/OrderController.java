package com.immoben.admin.order;
...
import com.immoben.admin.setting.SettingService;
import com.immoben.common.entity.Country;
import com.immoben.common.entity.order.Order;
import com.immoben.common.entity.order.OrderDetail;
import com.immoben.common.entity.order.OrderStatus;
import com.immoben.common.entity.order.OrderTrack;
import com.immoben.common.entity.product.Product;
import com.immoben.common.entity.setting.Setting;
import com.immoben.common.exception.OrderNotFoundException;
...
public class OrderController {
	...
	public String listByPage(
			...
			@AuthenticationPrincipal ImmobenUserDetails loggedUser) {
	...
	public String deleteOrder(@PathVariable("id") Integer id, Model model, RedirectAttributes ra) {
		try {
			...
			ra.addFlashAttribute("message", "La commande avec ID: " + id + " a été supprimée.");
		} catch (OrderNotFoundException ex) {
			ra.addFlashAttribute("message", ex.getMessage());
		}
	...
	public String editOrder(@PathVariable("id") Integer id, Model model, RedirectAttributes ra,
		...
		try {
			...
			model.addAttribute("pageTitle", "Modifier la commande avec (ID: " + id + ")");
			model.addAttribute("order", order);
	...
	public String saveOrder(Order order, HttpServletRequest request, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "La commande avec Id: " + order.getId() + " a été modifiée avec succès !");
