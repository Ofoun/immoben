...
public class CategoryController {
	...
	public String newCategory(Model model) {
		...
		model.addAttribute("listCategories", listCategories);
		model.addAttribute("pageTitle", "Créer une nouvelle catégorie");
...
//			FileUploadUtil.saveFile(uploadDir, fileName, multipartFile);
		...
		ra.addFlashAttribute("message", "La catégorie <" + category.getName() + "> a été enregistrée avec succès !");
	...
	public String editCategory(@PathVariable(name = "id") Integer id, Model model,
		...
		try {
			...
			model.addAttribute("listCategories", listCategories);
			model.addAttribute("pageTitle", "Modifier la catégorie avec (ID: " + id + ")");
	...
	public String updateCategoryEnabledStatus(@PathVariable("id") Integer id,
		...
		String message = "La catégorie <" + category.getName() + "> a été " + status;
	...
	public String deleteCategory(@PathVariable(name = "id") Integer id, 
		...
		try {
			...
			redirectAttributes.addFlashAttribute("message", 
					"La catégorie '" + category.getName() + "' avec ID: " + category.getId() + "  a été supprimée avec succès !");
		} catch (CategoryNotFoundException ex) {
