...
public class UserService {
	...
	public User get(Integer id) throws UserNotFoundException {
		try {
			...
			throw new UserNotFoundException("Aucun utilisateur avec l'identifiant '" + id + "' n'a été trouvé.");
		}
	}
	...
	public void delete(Integer id) throws UserNotFoundException {
		...
		if (countById == null || countById == 0) {
			throw new UserNotFoundException("Il n'existe aucun utilisateur avec l'identifiant " + id);
		}
